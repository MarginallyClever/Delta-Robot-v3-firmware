...
void outputsteps() {
  Serial.print(F("\ta="));   Serial.print(robot.arms[0].last_step);  Serial.print(F(" > "));  Serial.print(robot.arms[0].new_step);
  Serial.print(F("\tb="));   Serial.print(robot.arms[1].last_step);  Serial.print(F(" > "));  Serial.print(robot.arms[1].new_step);
  Serial.print(F("\tc="));   Serial.print(robot.arms[1].last_step);  Serial.print(F(" > "));  Serial.println(robot.arms[2].new_step);
}
